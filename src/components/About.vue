  ...
  <div>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      <div class="prose prose-lg max-w-none">
        ...
        <p>This explosion of powerful new technology has created unprecedented opportunity for developers and entrepreneurs to provide new products and solutions.</p>
        ...
        <p>In this podcast, we’ll chat with AI hackers to hear what they’re building and learn about the tools and techniques that are empowering them to create.</p>
      </div>
    </div>
  </div>
</template>
